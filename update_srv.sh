...
# bash сккрипт для автоматического обновления всех пакетов на сервере с уведомлением на почту

# 1. Для использования скрипта необходима установка mailx или mail
# 2. Необходимо изменить переменную EMAIL на свой адрес электронной почты
# 3. Необходимо добавить скрипт в cron, чтобы он выполнялся автоматически.
